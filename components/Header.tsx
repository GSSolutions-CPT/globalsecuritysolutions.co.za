...
export function Header() {
    ...
    return (
        ...
        >
            ...
            >
                <div className={cn("mx-auto transition-all duration-500", isScrolled ? "max-w-7xl w-full px-2" : "container px-5 lg:px-8")}>
                    <div className="flex justify-between items-center">
                        ...
                        <nav className="hidden lg:flex space-x-6 items-center">
                            {navItems.map((item, idx) => (
                                ...
                                >
                                    {item.dropdown ? (
                                        <button className={cn("flex items-center text-sm font-semibold transition-colors py-2 group cursor-pointer", 
                                        ...
                                        <Link
                                            href={item.href!}
                                            className={cn(
                                                "text-sm font-semibold transition-colors relative py-1 cursor-pointer",
                            ...
                            <div className="flex items-center gap-4 pl-4 border-l border-white/20">
                                ...
                                <Link
                                    href="/contact"
                                    className="relative group overflow-hidden bg-gradient-to-r from-red-600 to-red-500 text-white text-sm px-6 py-2.5 rounded-full font-bold shadow-lg shadow-red-500/25 transition-all duration-300 active:scale-95 hover:shadow-red-500/40 cursor-pointer"
                                >
                                    {/* Shine Effect */}
