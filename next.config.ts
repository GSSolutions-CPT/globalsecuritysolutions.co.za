...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/locations/durbanville/cctv-installation', destination: '/services/cctv-surveillance-systems', permanent: true },
      { source: '/locations/durbanville/alarm-systems', destination: '/services/alarm-system-installation', permanent: true },
      { source: '/locations/durbanville/access-control', destination: '/services/access-control-solutions', permanent: true },
