...
export default async function BlogPost(props: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <div className="min-h-screen bg-slate-50 pb-8 font-sans">
            ...
            {/* Minimal Header */}
            <div className="bg-slate-900 text-white pt-8 pb-4">
            ...
            <div className="container mx-auto px-4 max-w-4xl -mt-8 relative z-10">
                ...
                <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-sm border border-slate-100">
                    ...
                    {/* Call to Action */}
                    <div className="mt-4 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
