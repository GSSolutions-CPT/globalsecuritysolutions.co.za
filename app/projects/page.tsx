    ...
    return (
        <div className="bg-slate-50 min-h-screen font-sans">
            ...
            <div className="container mx-auto px-4 -mt-8 relative z-30 pb-8">
                ...
                <div className="mt-8 lg:mt-4 max-w-5xl mx-auto bg-blue-600 rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -mr-32 -mt-4" />
                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-black/10 rounded-full blur-3xl -ml-32 -mb-4" />
